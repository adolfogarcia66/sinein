    ...
    <>
      ...
      >
        ...
        <Box boxShadow={3}>
          ...
          >
            <Grid item xs={12} sm={6} md={4} lg={3}>
              <TextField label="Hechos" fullWidth />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
              <TextField label="Folio" fullWidth />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
              <TextField label="Victima" fullWidth />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
          ...
          >
            ...
            <Grid item xs={12} sm={6} md={4} lg={3}>
              <TextField label="Razon social/empresa" fullWidth />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
              <TextField label="Victimario" fullWidth />
            </Grid>
          </Grid>
